				...
				<div class="navbar navbar-nav mx-auto" style="padding-left: 15%;">
					<table class="navbar-nav">
						<tr>
							...
							<td class="nav-item "><a href="http://www.youtube.com/@TechStreet-wr8ob" target="_blank"> <i
			...
			<div class="col-md-5 pt-3">
				<div class="collapse navbar-collapse ml-auto" id="navbarNav">
					<div class="navbar-nav ml-auto">
						...
						<div class="dropdown" style="margin-top: 40px; padding-left: 5px;">
							...
							<ul class="dropdown-menu">
								<li><a class="dropdown-item " href="./profile.jsp">
										...
										<li><a class="dropdown-item " href="./update.jsp">
										Update Profile</a></li>
			...
			<div class="col-12">
				...
				<div class="collapse navbar-collapse" id="navbarNavAltMarkup"
					...
					<div class="navbar-nav">
						<a id="menu_bg" class="nav-link" href="./StudentHome.jsp"
							style="color: white; padding-left: 20px; font-size: 15px;">Home
						</a> <a id="menu_bg" class="nav-link" href="./courses.jsp"
							style="color: white; padding-left: 20px;">Courses</a> <a
							id="menu_bg" class="nav-link" href="http://www.youtube.com/@TechStreet-wr8ob"
							style="color: white; padding-left: 20px;">Videos</a> <a
							id="menu_bg" class="nav-link" href="./assignment.jsp"
							style="color: white; padding-left: 20px;">Assignment</a> <a
							id="menu_bg" class="nav-link" href="./aboutus.jsp"
							style="color: white; padding-left: 20px;">About Us</a> <a
							id="menu_bg" class="nav-link" href="./contactus.jsp"
							style="color: white; padding-left: 20px;">Contact Us</a>
							<a
							id="menu_bg" class="nav-link" href="./chatbot.jsp"
							style="color: white; padding-left: 20px;">Help</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content"
				...
				<div class="modal-body"
					style="font-size: 1.1rem; text-align: center; color: #333;">
					Are you sure you want to logout?</div>
				<div class="modal-footer" style="justify-content: center;">
					<button type="button" class="btn btn-secondary"
						data-bs-dismiss="modal"
						style="border-radius: 8px; margin-right: 10px;">No</button>
					<a href="login.jsp" class="btn btn-danger"
						style="border-radius: 8px;">Yes, Logout</a>
				</div>
			</div>
		</div>
	</div>
